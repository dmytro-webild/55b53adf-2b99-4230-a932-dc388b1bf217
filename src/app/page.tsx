...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Præcisionsarbejde",          description: "Ekspertteknikker der sikrer ensartede resultater af høj kvalitet ved hvert besøg.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3C1E0t8mxuGpZ0qBVz2J2MtoVjT/uploaded-1775573807501-gwlaxj6i.jpg",          imageAlt: "Præcisionsværktøj"},
        {
